...
public class ProductosED extends JFrame implements ActionListener, ItemListener, MouseListener {
    ...
    JComboBox cb_tipo;
    JButton bt_edit, bt_del, bt_insert, bt_sal;
    ...
    public ProductosED(){
        ...
        bt_sal.setBounds(245,550,200,50);
        add(bt_insert);
        add(bt_edit);
        add(bt_del);
        add(bt_sal);
